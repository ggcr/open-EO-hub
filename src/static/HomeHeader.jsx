                ...
                <div className="mx-auto mt-16 max-w-7xl px-3 sm:mt-24">
                    <div className="text-center">
                        ...
                        <div className='mt-8 flex gap-x-1 w-full justify-center items-baseline'>
                            <a href="https://github.com/ggcr/stac-api-client-react" target="_blank" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
